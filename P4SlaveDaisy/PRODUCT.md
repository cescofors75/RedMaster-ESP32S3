...
P4SlaveDaisy convierte una Guition ESP32-P4 JC1060P470C de 7 pulgadas en la superficie visual y táctil dedicada de RayDrone. Recibe por USB-C la telemetría del DSP y la forma de onda reducida —captura, parámetros, acorde, materiales, RAYS, MOTION, voces, niveles y limitador— con latencia visual baja. El audio sigue perteneciendo a Daisy Pod; P4 permite manipular Focus y elegir fuente, frecuencia, acorde, densidad objetivo y movimiento autónomo.
...
- La onda es una superficie de instrumento: tocar o arrastrar coloca Focus; Acorde abre diez voicings y Campo de granos abre RAYS/MOTION. El encoder físico de Daisy selecciona material.
...
- Transporte confirmado: USB CDC `0483:5740`; estado v3 de 58 bytes, chunks de onda de 64 bytes y comandos de 16 bytes, todos versionados y protegidos por CRC-16.
...
- Focus se manipula directamente sobre la onda; fuente, frecuencia, acorde y RAYS usan acciones táctiles discretas con blancos grandes. MOTION envía configuración atómica y Daisy confirma el estado aplicado.
